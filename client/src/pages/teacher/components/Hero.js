    ...
    return (
        <Grid container className={classes.root}>
            <Grid item sm={12} md={6} className={classes.description}style={{margin:'0 auto'}}>
              ...
              <p className={classes.subTitle}>Si vous voulez rejoindre notre équipe d'enseignants envoyer un Email :</p>
              <p style={{fontWeight:600, color:'#003668'}}className={classes.subTitle}><EmailIcon fontSize="large" style={{ verticalAlign:'middle' }}/> contact.drouci@gmail.com</p>
            </Grid>
