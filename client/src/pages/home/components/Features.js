      ...
      <Grid container className={classes.cardContainer}>
        <Grid item sm={3} className={classes.card}>
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            <DoneOutlineIcon style={{ fontSize: 50 }} />
          </div>
          <p className={classes.text}>
            Nos cours sont conçus avec une méthodologie personnalisée et
            flexible. Progressez à votre rythme avec les meilleurs enseignants
            de Tunisie
          </p>
        </Grid>
        <Grid item sm={3} className={classes.card}>
          ...
          <p className={classes.text}>
            Un accés à tous les contenus grace à notre site : 24h/24h et 7j/7j
            Offrez-vous toutes les chances de réussir avec un accompagnement
            adapté à chaque élève et étudiant.
          </p>
        </Grid>
        <Grid item sm={3} className={classes.card}>
          ...
          <p className={classes.text}>
            Suivez les cours confortablement depuis votre canapé. Nos cours sont
            100% conformes et adaptés à l'éducation nationale.
          </p>
        </Grid>
      </Grid>
    </div>
