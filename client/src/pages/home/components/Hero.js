    ...
    <Grid container className={classes.root}>
      ...
      <Grid item xs={12} md={6} className={classes.heroCta}>
        ...
        <p className={classes.subTitle}>
          Commencez nos cours en ligne de haute qualité.
          <br />
          Nos cours sont conformes à l'éducation nationale{" "}
          <img src={drapeau} className={classes.drapeau} alt='Tunisie' />
        </p>
      ...
      <Grid
        ...
        <img src={banner} alt='drouci' className={classes.image} />
      </Grid>
    </Grid>
  );
}
